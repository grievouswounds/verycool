...
const SEPOLIA: readonly RpcEndpoint[] = [
  { name: "publicnode", tier: 0, url: "https://ethereum-sepolia-rpc.publicnode.com" },
  { name: "1rpc", tier: 0, url: "https://1rpc.io/sepolia" },
  { name: "blastapi", tier: 0, url: "https://eth-sepolia.public.blastapi.io" },
  { name: "pocket", tier: 0, url: "https://eth-sepolia.publicnode.com" },
  { name: "drpc", tier: 1, url: "https://sepolia.drpc.org" },
  { name: "drpc-lb", tier: 1, url: "https://lb.drpc.org/ogrpc?network=sepolia" },
  ...
  { name: "tenderly-public", tier: 2, url: "https://gateway.tenderly.co/public/sepolia" },
  { name: "tenderly", tier: 2, url: "https://sepolia.gateway.tenderly.co" },
  { name: "notadegen", tier: 2, url: "https://rpc.notadegen.com/eth/sepolia" },
  { name: "unifra", tier: 2, url: "https://rpc-sepolia.unifra.io" },
];
...
export const resolvePoolEndpoints = (chainId: number, rpcUrl: string): readonly RpcEndpoint[] => {
  ...
  if (registered.length === 0) return [{ name: "manifest", tier: 0, url: rpcUrl }];
  if (registered.some((endpoint) => endpoint.url === rpcUrl)) return registered;
  return [{ name: "manifest", tier: 0, url: rpcUrl }, ...registered];
};
