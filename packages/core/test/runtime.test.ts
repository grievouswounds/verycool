...
const manifest = runtimeManifestSchema.parse({
  ...
  services: { databaseUrl: "postgresql://aqua@127.0.0.1:5432/aqua", apiUrl: "http://localhost:3000", mcpUrl: "http://localhost:3000/mcp", facilitatorUrl: "http://127.0.0.1:4022", brokerSocket: "/tmp/aqua.sock" },
  auth: { issuer: "http://localhost:3000", resource: "http://localhost:3000/mcp", rpId: "localhost", origin: "http://localhost:3000", pasetoPublicKeys: ["k4.public.0QPCsCVAycJZIZ13J36BogFriPmY0KXmGf99Jb_Qr3k"] },
  contracts: { aqua: contract("1"), aquaSwapRouter: contract("2"), limitSwapRouter: contract("3"), wrappedNativeToken: contract("4"), intentController: contract("5"), orderVaultFactory: contract("6"), permit2: contract("7"), x402ExactPermit2Proxy: contract("8") },
  fixtures: { tokens: [{ ...contract("9"), symbol: "BASE", decimals: 18 }, { ...contract("a"), symbol: "QUOTE", decimals: 6 }], pairs: [{ baseToken: address("9"), quoteToken: address("a") }] },
